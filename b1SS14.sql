...
SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Loi: Hệ thong gap su co mang dot ngot!';
...
-- Sự cố này vi phạm tính Atomicity (Tính nguyên tử) trong ACID
